    ...
    public function run()
    {
        ...
        SettingModel::insertOrIgnore([
            ...
            [
                ...
                'value' => 'eastman - Laravel Ecommerce system',
            ],
            [
                'key'   => 'theme-' . $theme . '-copyright',
                'value' => '© ' . now()->format('Y') . ' eastman. All Rights Reserved.',
            ],
            [
            ...
            [
                ...
                'value' => 'Welcome to eastman Online Shopping Store!',
            ],
            [
            ...
            [
                ...
                'value' => 'customercare@eastman.com',
            ],
            [
            ...
            [
                ...
                'value' => 'vendorsupport@eastman.com',
            ],
            [
        ...
        SettingModel::insertOrIgnore([
            [
                ...
                'value' => '© ' . now()->format('Y') . ' eastman. Tất cả quyền đã được bảo hộ.',
            ],
            [
                'key'   => 'theme-' . $theme . '-vi-welcome_message',
                'value' => 'Chào mừng đến với eastman - Cửa Hàng Mua Sắm Online!',
            ],
            [
