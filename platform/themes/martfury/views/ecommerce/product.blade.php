                        ...
                        <div class="ps-product__header">
                            ...
                            <div class="ps-product__info">
                                    ...
                                    <div class="ps-product__shopping">
                                        <figure>
                                            ...
                                            <div class="form-group--number product__qty">
                                                ...
                                                <input class="form-control qty-input" type="text" name="qty" value="1" placeholder="1" />
                                            </div>
                                        </figure>
                                ...
                                <div class="ps-product__sharing">
                                    <a class="facebook" href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($product->url) }}"  ><i class="fa fa-facebook"></i></a>
                                    <a class="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode($product->url) }}&summary={{ rawurldecode(strip_tags($product->description)) }}"  ><i class="fa fa-linkedin"></i></a>
                                    <a class="twitter" href="https://twitter.com/intent/tweet?url={{ urlencode($product->url) }}&text={{ strip_tags($product->description) }}"  ><i class="fa fa-twitter"></i></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="ps-tab" id="tab-reviews">
                                        ...
                                        @if ($product->reviews_count)
                                            @if (count($product->review_images))
                                                <div class="my-3">
                                                    <h4>{{ __('Images from customer') . ' (' . count($product->review_images) . ')' }}</h4>
