<header class="header--mobile">
    ...
    <div class=""><a class="header__site-link" href="{{ route('customer.logout') }}"><i class="icon-exit-right"></i></a></div>
</header>
        ...
        <header class="header--dashboard">
            ...
            @if (auth('customer')->user()->store && auth('customer')->user()->store->id)
                <div class="">
                    ...
                    @endif
                    <a class="header__site-link ms-2" href="{{ auth('customer')->user()->store->url }}"   ><span>{{ __('View your store') }}</span><i class="icon-exit-right"></i></a>
                </div>
            @endif
        </header>
