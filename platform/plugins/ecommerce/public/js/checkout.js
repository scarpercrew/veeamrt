...
/***/ "./platform/plugins/ecommerce/resources/assets/js/front/partials/address.js":
/*!**********************************************************************************!*\
  !*** ./platform/plugins/ecommerce/resources/assets/js/front/partials/address.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CheckoutAddress: () => (/* binding */ CheckoutAddress)
/* harmony export */ });
...
var CheckoutAddress = /*#__PURE__*/function () {
  function CheckoutAddress() {
    _classCallCheck(this, CheckoutAddress);
  }
  _createClass(CheckoutAddress, [{
    key: "init",
    value: function init() {
...
/***/ "./platform/plugins/ecommerce/resources/assets/js/front/partials/discount.js":
/*!***********************************************************************************!*\
  !*** ./platform/plugins/ecommerce/resources/assets/js/front/partials/discount.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DiscountManagement: () => (/* binding */ DiscountManagement)
/* harmony export */ });
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var DiscountManagement = /*#__PURE__*/function () {
  function DiscountManagement() {
    _classCallCheck(this, DiscountManagement);
  }
  _createClass(DiscountManagement, [{
    key: "init",
    value: function init() {
      $(document).on('click', '.btn-open-coupon-form', function (event) {
        event.preventDefault();
        $(document).find('.coupon-wrapper').toggle();
      });
      $('.coupon-wrapper .coupon-code').keypress(function (event) {
        if (event.keyCode === 13) {
      ...
      $(document).on('click', '.remove-coupon-code', function (event) {
        event.preventDefault();
        var _self = $(event.currentTarget);
        _self.find('i').remove();
        _self.html('<i class="fa fa-spin fa-spinner"></i> ' + _self.html());
...
"use strict";
/*!**************************************************************************!*\
  !*** ./platform/plugins/ecommerce/resources/assets/js/front/checkout.js ***!
  \**************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _partials_address__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./partials/address */ "./platform/plugins/ecommerce/resources/assets/js/front/partials/address.js");
/* harmony import */ var _partials_discount__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./partials/discount */ "./platform/plugins/ecommerce/resources/assets/js/front/partials/discount.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var MainCheckout = /*#__PURE__*/function () {
  function MainCheckout() {
    _classCallCheck(this, MainCheckout);
    new _partials_address__WEBPACK_IMPORTED_MODULE_0__.CheckoutAddress().init();
    new _partials_discount__WEBPACK_IMPORTED_MODULE_1__.DiscountManagement().init();
  }
    ...
    value: function init() {
      ...
      var loadShippingFeeAtTheFirstTime = function loadShippingFeeAtTheFirstTime() {
        ...
        if (shippingMethod.length) {
          ...
          $('.mobile-total').text('...');
          var isAddressAvailable = $('.customer-address-payment-form #address_id option:selected').val();
          var addressForm = $('.customer-address-payment-form').clone();
