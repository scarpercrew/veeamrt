                                    ...
                                    <div class="flexbox-content">
                                        <table>
                                            ...
                                            @if ((float)$shipment->cod_amount)
                                                <tr>
                                                    <td colspan="3" class="text-end p-sm-r border-none">
                                                        {{ trans('plugins/ecommerce::shipping.cash_on_delivery') }}:
                                                    </td>
                                                    <td class="text-end p-sm-r border-none">
                    ...
                    <div class="pd-all-20 p-t15 p-b15 border-top-title-main ps-relative">
                        <div class="flexbox-grid-form flexbox-grid-form-no-outside-padding mb10">
                            ...
                            <div class="flexbox-grid-form-item text-end">
                                <a    href="{{ route('orders.edit', $shipment->order->id) }}" class="hover-underline">{{ get_order_code($shipment->order->id) }}</a>
                            </div>
                        </div>
                        <div class="flexbox-grid-form flexbox-grid-form-no-outside-padding mb10">
                            <div class="flexbox-grid-form-item">
