                ...
                @foreach($products as $index => $product)
                    <tr data-product-id="{{ $product->id }}">
                        ...
                        <td class="pl5 p-r5 min-width-200-px" style="padding-top: 15px;">
                            <a class="hover-underline pre-line" href="{{ route('products.edit', $product->id) }}"   >{{ $product->name }}</a>
                        </td>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control input-mask-number" name="products_extra[{{ $index }}][price]" value="{{ $product->pivot->price }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <label class="control-label required">{{ trans('plugins/ecommerce::products.quantity') }}</label>
                                        <input type="text" class="form-control input-mask-number" name="products_extra[{{ $index }}][quantity]" value="{{ $product->pivot->quantity }}">
                                    </div>
                                </div>
                            </div>
                        </td>
        ...
        <td colspan="3" style="border-top: none; border-bottom: 1px solid #ececec;">
            <div class="row">
                <div class="col-6">
                    <div class="form-group mb-3">
                        <label class="control-label required">{{ trans('plugins/ecommerce::products.price') }}</label>
                        <input type="text" class="form-control input-mask-number" name="products_extra[__index__][price]" value="__price__">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group mb-3">
