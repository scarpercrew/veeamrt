                                            ...
                                            @foreach ($order->products as $orderProduct)
                                                ...
                                                @endphp
                                                    ...
                                                    <td class="pl5 p-r5 min-width-200-px">
                                                        <a class="text-underline hover-underline pre-line"    href="{{ $product ? route('products.edit', $product->original_product->id) : '#' }}" title="{{ $orderProduct->product_name }}">
                                                                ...
                                                                <li class="simple-note">
                                                                    ...
                                                                    <ul class="dom-switch-target line-item-properties small">
                                                                        <li class="ws-nm">
                                                                            ...
                                                                            <a class="text-underline bold-light"    title="{{ $order->shipping_method_name }}" href="{{ route('ecommerce.shipments.edit', $order->shipment->id) }}">{{ $order->shipping_method_name }}</a>
                                                                        </li>
                                                                        ...
                                                                        @if (is_plugin_active('marketplace') && $order->store->name)
                                                                            <li class="ws-nm">
                                                                                ...
                                                                                <a href="{{ $order->store->url }}" class="bold-light"   >{{ $order->store->name }}</a>
                                                                            </li>
                                                                        @endif
                                                                    </ul>
                                                                </li>
                                            ...
                                            <table class="table-normal table-none-border table-color-gray-text">
                                                ...
                                                <tr>
                                                    <td class="text-end mt10">
                                                        ...
                                                        @if ($order->payment->id)
                                                            <p class="mb0  font-size-12px"><a href="{{ route('payment.show', $order->payment->id) }}"   >{{ $order->payment->payment_channel->label() }}</a></p>
                                                        @endif
                                                    </td>
                                ...
                                <div class="pd-all-20">
                                    <div class="p-b10">
                                        ...
                                        <ul class="p-sm-r mb-0">
                                            <li class="ws-nm">
                                                <a href="{{ $order->store->url }}" class="ww-bw text-no-bold"   >{{ $order->store->name }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
