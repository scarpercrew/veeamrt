<div class="shipment-info-panel hide-print">
    <div class="shipment-info-header">
        <a    href="{{ route('ecommerce.shipments.edit', $shipment->id) }}">
        ...
        <div class="panel-heading order-bottom shipment-actions-wrapper">
            <div class="flexbox-grid-default">
                <div class="flexbox-content">
                    ...
                    <button class="btn btn-info ml10 btn-trigger-update-shipping-status">{{ trans('plugins/ecommerce::shipping.update_shipping_status') }}</button>
                </div>
            </div>
        </div>
    @endif
