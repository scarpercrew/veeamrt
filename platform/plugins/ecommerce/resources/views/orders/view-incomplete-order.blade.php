                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pl5 p-r5">
                                                        @if ($product->original_product->id)
                                                            <a    href="{{ route('products.edit', $product->original_product->id) }}" title="{{ $orderProduct->product_name }}">{{ $orderProduct->product_name }}</a>
                                                        @else
                        ...
                        <ul class="ws-nm">
                            ...
                            <li class="text-infor-subdued mt15">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <a    class="hover-underline" href="https://maps.google.com/?q={{ $order->full_address }}">{{ trans('plugins/ecommerce::order.see_maps') }}</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
