            ...
            @if (!in_array(get_application_currency()->title, $supportedCurrencies))
                <div class="alert alert-warning" style="margin-top: 15px;">
                    ...
                    <div style="margin-top: 10px;">
                        {{ __('Learn more') }}: <a href="https://support.paystack.com/hc/en-us/articles/360009973779"    rel="nofollow">https://support.paystack.com/hc/en-us/articles/360009973779</a>
                    </div>
                    @php
