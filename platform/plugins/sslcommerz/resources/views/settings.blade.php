...
<table class="table payment-method-item">
    ...
    <tr class="border-pay-row">
        ...
        <td class="border-right">
            <ul>
                <li>
                    <a href="https://sslcommerz.com"   >{{ __('SslCommerz') }}</a>
                            ...
                            <ul class="m-md-l" style="list-style-type:decimal">
                                <li style="list-style-type:decimal">
                                    <p>For registration in Sandbox, click the link <a
                                            href="https://developer.sslcommerz.com/registration/"   >https://developer.sslcommerz.com/registration</a></p>
                                    <p>For registration in Production, click the link <a
                                            href="https://signup.sslcommerz.com/register"   >https://signup.sslcommerz.com/register</a></p>
                                </li>
                                <li style="list-style-type:decimal">
                ...
                <div class="col-sm-6">
                    <div class="well bg-white">
                        ...
                        <p class="payment-note">
                            {{ trans('plugins/payment::payment.please_provide_information') }} <a    href="https://sslcommerz.com">SslCommerz</a>:
                        </p>
                        <div class="form-group mb-3">
