@if ($cookieConsentConfig['enabled'] && !$alreadyConsentedWithCookies)
    ...
    <div class=" cookie-consent cookie-consent-{{ theme_option('cookie_consent_style', 'full-width') }}" style="background-color: {{ theme_option('cookie_consent_background_color', '#000') }} !important; color: {{ theme_option('cookie_consent_text_color', '#fff') }} !important;">
