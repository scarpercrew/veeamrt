            ...
            @if (function_exists('get_application_currency') && !in_array(get_application_currency()->title, $supportedCurrencies))
                <div class="alert alert-warning" style="margin-top: 15px;">
                    ...
                    <div style="margin-top: 10px;">
                        {{ __('Learn more') }}: <a href="https://developer.paypal.com/docs/api/reference/currency-codes"    rel="nofollow">https://developer.paypal.com/docs/api/reference/currency-codes</a>
                    </div>
