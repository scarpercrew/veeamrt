                                    ...
                                    <div class="col-sm-6">
                                        <div class="well bg-white">
                                            ...
                                            <p class="payment-note">
                                                {{ trans('plugins/payment::payment.please_provide_information') }} <a    href="//www.stripe.com">Stripe</a>:
                                            </p>
                                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            ...
                                            <li class="payment-note">
                                                ...
                                                <ul class="m-md-l" style="list-style-type:decimal">
                                                    <li style="list-style-type:decimal">
                                                        <a href="//www.paypal.com/vn/merchantsignup/applicationChecklist?signupType=CREATE_NEW_ACCOUNT&amp;productIntentId=email_payments"   >
                                    ...
                                    <div class="col-sm-6">
                                        <div class="well bg-white">
                                            ...
                                            <p class="payment-note">
                                                {{ trans('plugins/payment::payment.please_provide_information') }} <a    href="//www.paypal.com">PayPal</a>:
                                            </p>
                                            <div class="form-group mb-3">
