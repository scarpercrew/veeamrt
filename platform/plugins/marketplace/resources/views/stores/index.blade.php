                ...
                <div class="form-group mb-3">
                    <div class="border-bottom py-2">
                        <div class="text-center">
                            ...
                            <div class="text-center">
                                <strong>
                                    <a href="{{ $store->url }}"   >{{ $store->name }} <i class="fas fa-external-link-alt"></i></a>
                                </strong>
                            </div>
                        </div>
                    </div>
                    <div class="py-2">
                        ...
                        <strong><a href="{{ route('customers.edit', $customer->id) }}"   >{{ $customer->name }} <i class="fas fa-external-link-alt"></i></a></strong>
                    </div>
                    <div class="py-2">
