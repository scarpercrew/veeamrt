                    ...
                    <div v-if="!isLoading && !verified">
                        ...
                        <div class="form-group mb-3">
                            <div>
                                ...
                                <div class="float-end text-end">
                                    <small><a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code"   >What's this?</a></small>
                                </div>
                        ...
                        <div class="form-group mb-3">
                            <label><input type="checkbox" name="license_rules_agreement" value="1" v-model="licenseRulesAgreement">Confirm that, according to the Envato License Terms, each license entitles one person for a single project. Creating multiple unregistered installations is a copyright violation.
                                <a href="https://codecanyon.net/licenses/standard"    rel="nofollow">More info</a>.</label>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <p>
                                ...
                                <a href="https://codecanyon.net/user/botble/portfolio"    rel="nofollow">new license here</a> to get a new purchase code.</small>
                            </p>
                        </div>
                    </div>
                    <div v-if="!isLoading && verified">
